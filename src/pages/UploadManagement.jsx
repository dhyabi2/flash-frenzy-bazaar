  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 p-4">
      <div className="container mx-auto max-w-2xl">
        ...
        >
          <h1 className="text-3xl font-bold mb-6 text-right text-indigo-800">رفع منتج لبيع اليوم الفلاشي</h1>
          <p className="mb-8 text-lg text-gray-600 text-right">الفئة: <span className="font-semibold text-indigo-600">{currentSale.category}</span></p>
                ...
                <div className="space-y-1 text-center">
                  {productImage ? (
                    <div className="relative">
                      <img src={URL.createObjectURL(productImage)} alt="Product" className="mx-auto h-32 w-32 object-cover rounded-lg" />
                      <button
                        type="button"
