  ...
  return (
    <div className="min-h-screen bg-gray-50 p-4">
      <div className="container mx-auto max-w-2xl">
        ...
        >
          <h1 className="text-3xl font-bold mb-6 text-right">رفع منتج لبيع اليوم الفلاشي</h1>
          <p className="mb-6 text-lg text-gray-700 text-right">الفئة: <span className="font-semibold">{currentSale.category}</span></p>
